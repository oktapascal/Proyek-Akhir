...
<!--Beadchumbs-->
    	...
    	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    		<div class="card">
    			<div class="header bg-red">
    				<h2>Tabel <?php echo $sub_navigasi; ?></h2><small>Silahkan Klik Detail Untuk Melihat Detail Data Gaji Pegawai</small>
    			</div>
    			<div class="body">
    				<div class="table-responsive">
    					<table class="table table-bordered table-striped table-hover dataTable" id="TabelGaji">
    						<thead>
    							<tr>
    ...
    <script type="text/javascript">
    	$(document).ready(function(){
    		var dataTable;
            var urlTable  = '<?php echo site_url('GajiUpah_Controller/LoadDataGaji'); ?>';
              dataTable = $('#TabelGaji').DataTable({
                    bAutoWidth: false,
                    responsive: true,
                    "processing":true,
                    "serverSide":true,
