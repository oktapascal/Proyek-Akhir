...
<body>
    		...
    		<div class="card">
    				...
    				<ul class="header-dropdown m-r--5">
    					<li class="dropdown">
    						...
    						<ul class="dropdown-menu pull-right">
                               <li><a role="button" data-toggle="modal" name="tambah" id="tambah" rel="modal:open">Tambah Pegawai Tetap</a></li>
                            </ul>
    					</li>
    				</ul>
    			</div>
    			<div class="body">
    				<div class="table-responsive">
    					<table class="table table-bordered table-striped table-hover dataTable" id="TabelPegawaiTetap">
    						<thead>
    							<tr>
    ...
    <?php $this->load->view('Pegawai/PegawaiTetap/PegawaiTetapDetail_View'); ?>

   	<script type="text/javascript">
        $(document).ready(function(){
            var dataTable;
            var urlTable  = '<?php echo site_url('PegawaiTetap_Controller/LoadPegawaiTetap'); ?>';
              dataTable = $('#TabelPegawaiTetap').DataTable({
                    bAutoWidth: false,
                    responsive: true,
                    "processing":true,
                    "serverSide":true,
              ...
              $('#tambah').click(function(){
                location.replace('<?php echo site_Url('/PegawaiTetap_Controller/TambahPegawaiTetap'); ?>');
        });
        });
         ...
         function lihatdata(id_pegawai)
        {
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url('PegawaiTetap_Controller/DetailPegawaiTetap/'); ?>' + id_pegawai,
                dataType: 'json',
                success: function(pegawai){
                    $('#ModalPegawaiTetapDetail').modal('show');
