	...
	<div class="block-header">
        ...
        <ol class="breadcrumb">
         <li>
          ...
          <li>
            <i class="material-icons">assignment_late</i> <?php echo $sub_navigasi; ?>
          </li>
        </ol>
    </div>
    <!--ENDBeadchumbs-->
			...
			<div class="card">
					...
					<ul class="header-dropdown m-r--5">
    					<li class="dropdown">
    						...
    						<ul class="dropdown-menu pull-right">
                               <li><a href="<?php echo site_url('Laporan_Controller/Cetak_HargaPokokProduksi/'); ?><?php echo $no_bulan?>/<?php echo $tahun; ?>" name="cetak" id="cetak">Cetak Harga Pokok Produksi</a></li>
                            </ul>
    					</li>
    				</ul>
				</div>
				<div class="body">
					<table class="table table-hover table-bordered">
						<thead>
						<tr>
							<th style="text-align: center;" colspan="4">Butik Malla Ramdani</th>
						</tr>
						<tr>
							<th style="text-align: center;" colspan="4">Laporan Harga Pokok Produksi</th>
						</tr>
						<tr>
						...
						<tbody>
							...
							<tr>
								<td style="text-align: left; font-weight: bold;" colspan="4">Biaya Bahan Baku:</td>
							</tr>
							<tr>
