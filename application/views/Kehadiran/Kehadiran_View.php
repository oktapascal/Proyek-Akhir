...
<!--Beadchumbs-->
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          <div class="header bg-red">
            <h2>Tabel <?php echo $navigasi; ?> <?php echo date('d-m-Y', strtotime($this->session->userdata('tanggal_presensi'))); ?></h2>
          </div>
          <div class="body table-responsive">
            <table class="table table-bordered table-striped table-hover dataTable" id="TabelAbsensi">
              <thead>
                <tr>
    ...
    <script type="text/javascript">
      var dataTable;
      var urlTable  = '<?php echo site_url('Presensi_Controller/LoadKehadiran'); ?>';
