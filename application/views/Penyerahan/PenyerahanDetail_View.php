...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="header bg-blue">
                <h2>Detail <?php echo $navigasi; ?> <?php echo $id_transaksi; ?> (Nomor Pesanan <?php echo $no_pesanan['no_pesanan']; ?>)</h2>
        ...
        <div class="body table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    <td style="text-align: center; font-weight: bold;" colspan="2">Total Nilai Penyerahan</td>
