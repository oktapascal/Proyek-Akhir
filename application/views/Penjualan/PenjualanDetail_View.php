    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="body table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    <td style="text-align: center;"><?php echo $dt['id_produk']; ?></td>
                    <td style="text-align: center;"><?php echo $dt['nama_produk'];; ?></td>
                    <td style="text-align: center;"><?php echo $dt['jumlah']; ?></td>
                    <td style="text-align: center;"><?php echo format_rp($dt['harga_jual']); ?></td>
                ...
                <tr>
                    <td style="text-align: center; font-weight: bold;" colspan="2">Total Nilai Penjualan</td>
