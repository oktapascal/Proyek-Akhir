                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-blue-grey">
                            <h2>
                                PILIH PRODUK
                                <small>Silahkan Pilih Produk yang Akan Ditentukan Bill Of Material (Bahan)</small>
                            </h2>
                        </div>
                        <div class="body">
             ...
             $('#PilihProduk').submit(function(e){
                ...
                $.ajax({
                    ...
                    success: function(respon){
                        ...
                        {
                            window.location.replace('<?php echo site_url('Bom_Controller/PilihBomBahan'); ?>')
                        }
                        else{
...
<?php if ($this->session->flashdata('notifikasi_bom')){ ?>
<script type="text/javascript">
$(document).ready(function($){
Push.Permission.request(() => {
Push.create('NOTIFIKASI', {
body: '<?php echo $this->session->flashdata('notifikasi_bom'); ?>',
