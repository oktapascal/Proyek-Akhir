                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-blue-grey">
                            <h2>UPDATE DATA BAHAN PENOLONG<small>Sebelum Update, Pastikan Anda Sudah Yakin Untuk Mengubah Data Bahan Penolong ini.</small></h2>
                        </div>
                        <div class="body">
                           <?php echo form_open('BahanPenolong_Controller/UpdateBahanPenolong', array('id'=>'UpdateBahanPenolong')); ?>
			    		...
			    		<button type="submit" class="btn btn-block btn-lg btn-primary waves-effect">UPDATE BAHAN PENOLONG</button>
						<?php echo form_close(); ?>
                        </div>
                    </div>
               </div>
     ...
     <script type="text/javascript">
     	$(document).ready(function(){
            ...
            $(element).parents('.form-group').append(error);
             ...
             //Submit Update Bahan Penolong//
             $('#UpdateBahanPenolong').submit(function(e){
                e.preventDefault();
                $.ajax({
                    url: $('#UpdateBahanPenolong').attr('action'),
                    type: $('#UpdateBahanPenolong').attr('method'),
                    data: $('#UpdateBahanPenolong').serialize(),
                    dataType: 'json',
                    success: function(respon){
                        ...
                        if(respon.success == true)
                        {
                            ...
                            var text      = "Data Bahan Penolong Berhasil Diubah";
                            showNotification(colorName, text, placementFrom, placementAlign, animateEnter, animateExit);
                            setTimeout(function(){location.href="<?php echo site_url('BahanPenolong_Controller/index') ?>"} , 2000);

                            Push.Permission.request(() => {
                            Push.create('NOTIFIKASI', {
                            body: 'Data Bahan Penolong Berhasil Diubah',
