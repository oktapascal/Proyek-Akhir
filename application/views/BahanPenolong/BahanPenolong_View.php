...
<body>
    		...
    		<div class="card">
    				...
    				<ul class="header-dropdown m-r--5">
    					<li class="dropdown">
    						...
    						<ul class="dropdown-menu pull-right">
                               <li><a role="button" name="tambah" id="tambah">Tambah Bahan Penolong</a></li>
                            </ul>
    					</li>
    				</ul>
    			</div>
    			<div class="body">
    				<div class="table-responsive">
    					<table class="table table-bordered table-striped table-hover dataTable" id="TabelBahanPenolong">
    						<thead>
    							<tr>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
              var dataTable;
              var urlTable  = '<?php echo site_url('BahanPenolong_Controller/LoadBahanPenolong'); ?>';
              dataTable = $('#TabelBahanPenolong').DataTable({
                    bAutoWidth: false,
                    responsive: true,
                    "processing":true,
                    "serverSide":true,
              ...
              $('#tambah').click(function(){
                location.replace('<?php echo site_Url('/BahanPenolong_Controller/TambahBahanPenolong'); ?>');
        });
